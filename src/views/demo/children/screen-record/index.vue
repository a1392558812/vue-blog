<template>
  <div class="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 p-8">
    <div class="max-w-7xl mx-auto">
      <div
        v-if="!isSupported"
        class="flex items-center justify-center h-96 bg-white rounded-xl shadow-lg"
      >
      ...
      <div v-else class="flex flex-wrap gap-6 justify-center">
        ...
        >
          ...
          >
            ...
            <button
              @click="enabled ? stopRecorderVideo() : startRecorderVideo()"
          ...
          <video
            class="block w-[500px] h-auto border-2 border-indigo-100 rounded-lg m-4"
            ref="videoRef"
            muted
            download
            autoplay
