<template>
  <div class="max-w-[1200px] mx-[auto] my-[0]">
    <header class="text-center mb-[40px] px-[0] py-[20px]">
      ...
      <p class="text-[1.1rem] max-w-[600px] mx-[auto] my-[0] text-[#666]">
        选择一个主题色，自动生成7个和谐配色和3个辅色
      </p>
    </header>
    ...
    <div class="palettes-container">
      <div
        class="bg-[var(--card-bg)] rounded-[var(--border-radius)] overflow-hidden [box-shadow:var(--box-shadow)]"
      >
        <div
          class="px-[20px] py-[15px] [font-weight:600] text-[1.1rem] [border-bottom:1px_solid_rgba(0,_0,_0,_0.05)]"
        >
          主配色方案
        </div>
