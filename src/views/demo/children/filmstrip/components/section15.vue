<template>
    <section>
        ...
        <section>
            <h2 style="vertical-align: bottom">赤壁怀古<span style="font-size: 20px;">【宋】苏辙 </span></h2>
            <p>新破荆州得水军，</p>
            ...
            <p><span class="fragment highlight-red">意突</span> <span class="fragment highlight-blue">成功</span> <span class="fragment highlight-green">所未闻。</span></p>
        </section>
    </section>
</template>
