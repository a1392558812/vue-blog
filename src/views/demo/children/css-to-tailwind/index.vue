  ...
  <div class="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="bg-blue-600 text-white px-4 py-3 font-medium">输入CSS代码</div>
          <textarea
        ...
        <div
          class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md"
        >
          <div class="bg-purple-600 text-white px-4 py-3 font-medium">输入主题配置（JSON）</div>
          <textarea
            ...
            v-model="customTheme"
            placeholder='请输入JSON格式主题配置，无需配置可填"{}"'
          />
        </div>
        ...
        <div
          class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md"
        >
          <div class="bg-green-600 text-white px-4 py-3 font-medium">输出结果</div>
