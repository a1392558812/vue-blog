<template>
    <div class="flex align-items-center justify-content-center my-signature">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="400pt" height="120pt" viewBox="0 0 400.000000 120.000000">
            <g transform="translate(0.000000,120.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                <path d="M890 728 c-25 -12 -92 -69 -149 -125 -57 -57 -105 -103 -107 -103 -2
                ...
                <path d="M1323 461 c-13 -14 -26 -41 -29 -60 -11 -65 -146 -183 -176 -153 -14
                ...
                <path d="M1509 455 c-94 -49 -173 -169 -139 -210 15 -18 59 -19 97 -3 37 16
                ...
                23z" />
                <path d="M1801 446 c-47 -32 -72 -36 -36 -6 19 16 19 30 1 30 -8 0 -50 -46
