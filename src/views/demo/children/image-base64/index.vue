<template>
  <div
    class="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 p-8 flex items-center justify-center"
  >
    <div class="container max-w-7xl mx-auto">
      <h1 class="text-[clamp(1.5rem,3vw,2.5rem)] font-bold text-gray-800 text-center mb-10">
        图片转Base64工具
      </h1>
      ...
      <div class="flex flex-col lg:flex-row gap-8 items-stretch justify-center">
        <!-- 图片预览区域 -->
        <div
          class="w-full max-w-[600px] bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100"
        >
            ...
            <div class="mt-4 flex flex-col gap-2">
              ...
              <div class="grid grid-cols-2 gap-4 mt-2">
                ...
                <div class="bg-purple-50 p-3 rounded-lg">
                  ...
                  <span class="font-semibold text-purple-700 ml-1">{{
