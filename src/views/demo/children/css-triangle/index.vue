<template>
    <div class="flex align-items-stretch justify-content-center css-triangle">
        <div class="css-triangle-filed">
            ...
            <div class="css-triangle-params">
                <span>宽：</span>
                <input class="css-triangle-input" type="number" :value="params.width" @input="function(e) { onInput(e, 'width') }" placeholder="请输入三角形的宽">
            </div>
            <div class="css-triangle-params">
                <span>高：</span>
                <input class="css-triangle-input" type="number" :value="params.height" @input="function(e) { onInput(e, 'height') }" placeholder="请输入三角形的高">
            </div>
            <div class="css-triangle-params">
                <span>旋转角度：</span>
