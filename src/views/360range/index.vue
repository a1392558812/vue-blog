<template>
  <div class="width100 height100 panorama-wrap">
    ...
    const init360Panorama = () => {
      const intro = () => {
        return new Promise(resolve => {
          ...
          const photoSphereViewerAnimation = new utils.Animation({
            ...
            console.log('photoSphereViewerAnimation', photoSphereViewerAnimation)
            resolve()
          })
        })
      }
